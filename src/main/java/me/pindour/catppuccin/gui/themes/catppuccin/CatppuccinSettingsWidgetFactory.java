...
public class CatppuccinSettingsWidgetFactory extends SettingsWidgetFactory {
    ...
    public CatppuccinSettingsWidgetFactory(CatppuccinGuiTheme theme) {
        super(theme);
    ...
    private void boolW(WTable table, BoolSetting setting) {
        ...
        WCatppuccinCheckbox checkbox = (WCatppuccinCheckbox) list.add(theme.checkbox(setting.get())).widget();
    ...
    private void intW(WTable table, IntSetting setting) {
        WCatppuccinIntEdit edit = table.add(theme.catppuccinIntEdit(setting)).expandX().widget();
    ...
    private void keybindW(WTable table, KeybindSetting setting) {
        ...
        WCatppuccinKeybind keybind = list.add(theme.catppuccinKeybind(setting.title, setting.get(), setting.getDefaultValue())).expandX().widget();
    ...
    private void fontW(WTable table, FontFaceSetting setting) {
        ...
        WCatppuccinLabel label = (WCatppuccinLabel) theme.label(getFontLabel(setting, setting.get().info.family()));
    ...
    private static class WSelectedCountLabel extends WCatppuccinLabel {
