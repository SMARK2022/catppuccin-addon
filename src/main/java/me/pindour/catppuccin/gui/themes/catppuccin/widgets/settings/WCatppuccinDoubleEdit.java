...
public class WCatppuccinDoubleEdit extends WVerticalList implements CatppuccinWidget {
    ...
    public WCatppuccinDoubleEdit(DoubleSetting setting) {
        this(setting.title,
            setting.description,
            setting,
            setting.get(),
    ...
    public WCatppuccinDoubleEdit(String title, String description, DoubleSetting setting, double value, double min, double max, int decimalPlaces, double sliderMin, double sliderMax, boolean noSlider) {
        this.title = title;
